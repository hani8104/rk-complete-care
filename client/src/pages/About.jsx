                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white z-10">
                                ...
                                />
                                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-blue-900/90 to-transparent p-8 text-white">
                                    <h3 className="text-2xl font-black">Dr. Piyush Sharma (PT)</h3>
                                    <p className="text-blue-200 font-bold text-sm uppercase tracking-wider mt-1">Chief Physiotherapist</p>
                                    <p className="text-xs text-white/70 mt-2 font-medium">BPT, MPT (Orthopedics & Sports), MIAP</p>
                                </div>
                            </div>
                            {/* Decorative element */}
                        ...
                        >
                            ...
                            <h1 className="text-4xl md:text-5xl font-black text-slate-900 mb-6 leading-tight">
                                Dr. Piyush <span className="text-blue-700">Sharma</span>
                            </h1>

                            <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
                                <p>
                                    <strong className="text-slate-900">Dr. Piyush Sharma</strong> is the Chief Physiotherapist at Welton Hospital. He specializes in treating patients with orthopedic problems and disabilities, bringing years of expertise and a compassionate approach to patient care.
                                </p>
                                <p>
                                    With a vast experience in the field, he has successfully treated thousands of patients suffering from conditions such as:
                                </p>
                                <ul className="grid grid-cols-1 md:grid-cols-2 gap-y-3 gap-x-6 text-base font-medium">
                                    {[
